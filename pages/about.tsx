      ...
      <article className="bg-zinc-800 rounded-lg p-10 pt-6 pb-4 m-4 mb-8 max-w-4xl border border-black">
        ...
        <section className="mb-6">
          ...
          <p className="text-gray-200">
            Are you looking for the best Rust servers to play on? With the Rust
            Servers Filter, you can easily search for servers based on various
            criteria such as wipe, player limit, and server rates. Whether you
            prefer playing solo, duo, trio, or quad, this tool allows you to
            filter server for your preferred playstyle. Additionally, you can
            search for servers with specific rates, such as 2x, 3x, or 5x, to
            find exactly what you are looking for. With advanced filtering
            options and the ability to sort by last wipe, next wipe and
            distance.
          </p>
        </section>
        <section className="mb-6">
          ...
          <p>
            I made this website because other server finders did not meet what
            we needed. We wanted to find upcoming wipes of servers or also
            filter by solo duo trio and with all of that find specific rates.
            Also I can see upcoming wipes so we can be ready for the first
            minutes of freshly wiped servers. Other server finders do not do
            that or do that at very limited way. So for myself and my friends I
            provide best rust server list there is!
          </p>
        </section>
        <Link
