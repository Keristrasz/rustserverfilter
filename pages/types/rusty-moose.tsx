...
const title = "Rusty Moose Servers | RUST Server Filter for Rusty Moose Gaming";
const desc =
  "Delve into Rusty Moose gaming on their official servers. Customize your Rusty Moose adventure using the server filter, sorting by wipe schedules, player populations, and geographical proximity. Join today and test your skills on Rusty Moose servers!";
const h1 = "RUSTY MOOSE SERVERS";
const addr = "https://rustserverfilter.com/types/rusty-moose";
