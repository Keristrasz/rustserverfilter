...
const title = "Rustoria Servers | Rust Server Filter - Unleash Rustoria's Gameplay";
const desc =
  "Unleash Rustoria's gameplay on their official servers. Filter by wipe cycles, player counts, and distance to thrive in the Rustoria realm. Join now and conquer Rustoria's challenges!";
const h1 = "RUSTORIA SERVERS";
const addr = "https://rustserverfilter.com/types/rustoria";
