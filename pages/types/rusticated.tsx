...
const title = "Rusticated Servers | Filter for Rusticated Gaming Experience";
const desc =
  "Immerse yourself in the Rusticated gaming experience on their official servers. Filter servers by wipe frequency, player activity, and distance for a Rusticated adventure. Join now and enjoy the Rusticated community!";
const h1 = "RUSTICATED SERVERS";
const addr = "https://rustserverfilter.com/types/rusticated";
