      ...
      : [
          {
            ...
            headers: [
              ...
              // Helps prevent cross-site scripting (XSS), clickjacking and other code injection attacks.
              {
                ...
                value:
                  "default-src 'self'; style-src 'self' https://fonts.googleapis.com https://fonts.gstatic.com; font-src 'self' https://fonts.gstatic.com https://fonts.googleapis.com; img-src 'self' https://flagsapi.com/; script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://vercel.live https://fonts.googleapis.com https://fonts.gstatic.com 'wasm-unsafe-eval'; connect-src 'self' 'https://region1.google-analytics.com' https://realm.mongodb.com https://vitals.vercel-insights.com/ https://ipapi.co/; object-src 'none'",
              },
