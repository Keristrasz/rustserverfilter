...
const title = "Best Beginner Servers | Rust Server Filter - Start Your Rust Journey Here";
const desc =
  "Looking for the best Rust beginner servers for new players? Our server filter allows you to narrow down options by wipe frequency, player activity, and distance. Find your beginner server now!";
const h1 = "BEST BEGINNER SERVERS";
const addr = "https://rustserverfilter.com/types/types/best-beginner-servers";
