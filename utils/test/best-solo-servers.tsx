...
const desc =
  "Searching for Rust solo servers? Our server filter allows you to narrow down options by wipe frequency, player population, and proximity. Don't compromise – find the best solo servers today!";
const h1 = "BEST SOLO SERVERS";
const addr = "https://rustserverfilter.com/types/best-solo-servers";
