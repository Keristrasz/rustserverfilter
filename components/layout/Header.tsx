  ...
  return (
    <header className="flex justify-between items-center w-full bg-rustOne px-4">
      <Link href="/" className="flex justify-between items-center hover:text-white">
        ...
        <div>
          <h2 className="font-rust text-2xl lg:text-4xl tracking-[0.065rem] [text-shadow:_3px_3px_0_rgb(0_0_0_/_40%)]">
            RUST SERVER FILTER
          </h2>
      ...
      <div>
        <Link
          href="/"
          className="hidden text-gray-200 [text-shadow:_3px_3px_0_rgb(0_0_0_/_40%)] font-rust tracking-[0.100rem] text-center px-1 mx-4 rounded sm:w-30 text-sm lg:text-lg transition-all cursor-pointer hover:text-white
          md:block"
        >
          HOME
        </Link>
