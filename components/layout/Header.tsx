  ...
  return (
    <header className="flex justify-between items-center w-full bg-rustOne px-4">
      ...
      <div>
        <Link
          href="/"
          className="text-gray-200 [text-shadow:_3px_3px_0_rgb(0_0_0_/_40%)] font-rust tracking-[0.100rem] text-center px-1 mx-4 rounded sm:w-30 text-sm md:text-lg transition-all cursor-pointer hover:text-white
          block"
        >
          HOME
        </Link>
